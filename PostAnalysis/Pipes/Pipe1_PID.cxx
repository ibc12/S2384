...
void Pipe1_PID(const std::string& beam, const std::string& target, const std::string& light, bool isFiltered)
{
    ...
    auto hTwoSils {new TH2D {"hTwoSils", ";#DeltaE_{0} [MeV];#DeltaE_{1} [MeV]", 800, 0, 80, 500, 0, 50}};
    ...
    cuts.ReadCut("l1", TString::Format("./Cuts/pid_%s_ql1_%s.root", light.c_str(), beam.c_str()).Data());
