...
const TH1DModel Ex {
    "hEx", TString::Format("Excitation energy;E_{x} [MeV];Counts / %.f keV", (35. - (-10.)) / 1200 * 1e3), 1200, -10, 35};
...
const TH2DModel ExZ {"hExZ", "E_{x} dependence on SP.Z();SP.Z() [mm];E_{x} [MeV]", 300, -10, 400, 200, -10, 20};
